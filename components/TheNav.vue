<template>
  <div>
    ...
    <ul class="flex pt-5 pb-5 pl-5 pr-5">
      <li class="mr-6">
        <nuxt-link class="text-blue-500 hover:text-blue-800" to="/">Accueil | </nuxt-link>
        <nuxt-link class="text-blue-500 hover:text-blue-800" to="/product/get">All posts | </nuxt-link>
